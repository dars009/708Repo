...
public class StudentController {
	...
	@GetMapping(path = "/jpqlWhere")
	public List<Student> jpqlWhere() {
		return studentService.jpql_where();
	}
	

	@GetMapping(path = "/nativeWhere")
	public List<Student> nativeWhere() {
		return studentService.native_where();
	}

	
	@GetMapping(path = "/usingQueryAnnotation")
	public List<Student> usingQueryAnnotation() {
		return studentService.usingQueryAnnotation();
	}
}
